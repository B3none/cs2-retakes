...
## Installation
- Download the zip file from the [latest release](https://github.com/B3none/cs2-retakes/releases), and extract the contents into your `addons/counterstrikesharp/plugins` directory.
- Download the latest and put it into your `addons/counterstrikesharp/shared` directory.
